...
`;function J(){if(typeof document>"u"||document.getElementById("chaoscraft-responsive-utilities"))return;const n=document.createElement("style");n.id="chaoscraft-responsive-utilities",n.textContent=H,document.head.appendChild(n)}typeof document<"u"&&document.addEventListener("DOMContentLoaded",()=>{J(),M(),O(),N(h),j("robot-container"),G("joke-container-wrapper"),S()});
//# sourceMappingURL=main-B3vH9978.js.map
